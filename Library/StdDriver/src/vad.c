...
void VAD_WriteBIQCoeff(VAD_T *vad, uint8_t u8Coeff, uint32_t u32Value)
{
	switch(u8Coeff)
	{
		...
		case VAD_COEFF_A1:	(vad)->BIQ_CTL0 = ((vad)->BIQ_CTL0 & ~VAD_BIQ_CTL0_BIQA1_Msk)|((u32Value<<VAD_BIQ_CTL0_BIQA1_Pos)&VAD_BIQ_CTL0_BIQA1_Msk);	break;	
		case VAD_COEFF_A2:	(vad)->BIQ_CTL0 = ((vad)->BIQ_CTL0 & ~VAD_BIQ_CTL0_BIQA2_Msk)|((u32Value<<VAD_BIQ_CTL0_BIQA2_Pos)&VAD_BIQ_CTL0_BIQA2_Msk);	break;			
	}
}
