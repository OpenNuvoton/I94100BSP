...
#define CLK_PLLCTL_98MHz_HXT    (CLK_PLLCTL_PLLSRC_HXT  | CLK_PLLCTL_NR(2) | CLK_PLLCTL_NF( 32) | CLK_PLLCTL_NO_4) /*!< Predefined PLLCTL setting for 98.304MHz PLL output with HXT(12MHz X'tal) */
#define CLK_PLLCTL_98MHz_HIRC   (CLK_PLLCTL_PLLSRC_HIRC | CLK_PLLCTL_NR(8) | CLK_PLLCTL_NF( 32) | CLK_PLLCTL_NO_4) /*!< Predefined PLLCTL setting for 96MHz PLL output with HIRC(50MHz IRC) */
#define CLK_PLLCTL_96MHz_HIRC   (CLK_PLLCTL_PLLSRC_HIRC | CLK_PLLCTL_NR(6) | CLK_PLLCTL_NF( 24) | CLK_PLLCTL_NO_4) /*!< Predefined PLLCTL setting for 96MHz PLL output with HIRC(50MHz IRC) */
...
__STATIC_INLINE uint32_t CLK_GetPLLClockFreq(void)
{
    ...
    u32NR = ((u32PllReg & CLK_PLLCTL_INDIV_Msk) >> CLK_PLLCTL_INDIV_Pos) + 1;
		...
		// Check for overflow
		if(u32FIN*u32NF > u32FIN)
			u32PllFreq = (((u32FIN*u32NF)/u32NR)*2)/u32NO;
		else
